CLASS zcl_170423842_open_sql_v2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170423842_open_sql_v2 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA:
    lt_insert TYPE TABLE OF z170423842_t_emp.

    DELETE FROM z170423842_t_emp.
...
*--------------------------------------------------------------------*
    ...
    INSERT z170423842_t_emp FROM TABLE @lt_insert.
...
* İşlem: Birleştirme (CONCAT), Parçalama (SUBSTRING), Büyük/Küçük harf ve Karakter dol
*--------------------------------------------------------------------*
